  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl p-8">
        <h2 className="text-3xl font-bold text-[#FF9D23] text-center mb-8">
          Create Listing
        </h2>
        {error && (
        ...
        <div className="space-y-4">
          <input
            ...
            name="images"
            multiple
            className="w-full px-4 py-3 rounded-lg bg-[#D4BEE4] border border-[#D4BEE4] focus:outline-none focus:border-[#FF9D23] focus:ring-1 focus:ring-[#FF9D23] transition-all duration-200"
          />
          <input
            type="text"
            value={name}
